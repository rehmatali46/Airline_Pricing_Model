...
fig.update_layout(barmode='group', template="plotly_white", title="Price Analysis", xaxis_title="Category", yaxis_title="Price (₹)", plot_bgcolor='#e6f3ff', paper_bgcolor='#e6f3ff', font_color="#1a2a44")
st.plotly_chart(fig)
